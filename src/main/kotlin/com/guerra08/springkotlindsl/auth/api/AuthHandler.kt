...
import com.guerra08.springkotlindsl.auth.contract.AuthResponse
...
class AuthHandler(
    ...
    fun signUp(req: ServerRequest): ServerResponse {
        ...
        val token = authService.signUp(userContract)
        return ServerResponse.ok().body(AuthResponse("Bearer", token))
    }
